    ...
    <div className="w-full">
      ...
      <div className="lg:flex flex lg:flex-row flex-col justify-center gap-x-10 lg:ml-10 lg:px-0 px-2">
        <div className="lg:hidden flex absolute z-50 bottom-0 left-[50%] translate-x-[-50%]">
          <button className=" bg-[black] text-[#6EDB47] border-[3px] border-[#6EDB47] lg:m-0 m-2 py-2 px-10 rounded-xl">
            Owned
          </button>
        </div>
        <div className="basis-5/12">
          ...
          <div className="flex justify-between">
            ...
            <div className="lg:self-end flex-col gap-y-2 lg:flex hidden">
              <button className=" border-[3px] border-[#6EDB47] text-[#6EDB47] lg:m-0 m-2 py-2 px-4 rounded-xl">
                Owned
              </button>
          ...
          <p className="text-center mt-4 mb-7">
            Submit your attendace before you join
          </p>
          ...
          <div className="flex flex-col  gap-y-10 h-[440px] mb-5 overflow-scroll">
        ...
        <div className="basis-5/12 flex flex-col lg:order-last order-first">
          ...
          <div className="flex justify-between lg:mt-4 lg:mb-3 my-3 items-center ">
            ...
            >
              {!expandPhotoRoll ? "Expand" : "collapse"}
            </p>
            <p
